...
var _cpp = __webpack_require__(8);

var _cpp2 = _interopRequireDefault(_cpp);

var _python = __webpack_require__(9);
...
function patchCPP(selectHTML, toggleLangHTML) {
  var mainContainer = document.querySelector("#titlearea");
...
function patchPython(selectHTML, toggleLangHTML) {
  ...
  container.innerHTML = "<div class=\"title-line pv-title-python\">" + selectHTML + toggleLangHTML + "</div>";
...
function buildLanguageToggle(currentVersion, activeLang) {
  return "<a href=\"/paraview-docs/" + currentVersion + "/cxx\" class=\"title-line pv-lang-link " + (activeLang == 'cxx' ? 'active' : '') + "\"><img alt=\"C++ documentation\" title=\"C++ documentation\" class=\"lang-logo cpp\" src=\"/paraview-docs/" + _cpp2.default + "\"/> C++</a><a class=\"title-line pv-lang-link " + (activeLang == 'python' ? 'active' : '') + "\" href=\"/paraview-docs/" + currentVersion + "/python\"><img alt=\"Python documentation\" title=\"Python documentation\" class=\"lang-logo python\" src=\"/paraview-docs/" + _python2.default + "\" /> Python</a>";
}

// ----------------------------------------------------------------------------

function patchURL(url, new_version, new_lang) {
  var lang = new_lang || urlRegExp.exec(window.location.href)[2];
...
function updateDropDown() {
  fetchText("/paraview-docs/versions").then(function (txt) {
    ...
    if (match) {
      ...
      var selectHTML = buildDropDown(versions, activeVersion, lang, otherLang);
      var toggleLangHTML = buildLanguageToggle(activeVersion, lang);
...
module.exports = __webpack_require__.p + "02d66cb83e1f24d23569da0d879dc76e.png";

/***/ }),
/* 9 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "45f9a58a3045c58f6dc7dc9a3c259dd1.png";
